...
_COMPACT_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "smx_perceive": "smx 感知层（opt-in）：wait 用 satisfied=true/false/null+sample_count/observer_error_count；snapshot 绑定 scope；diff 给 comparable/field_completeness；receipt 水合 raw grounding 并标 canonical=false；只感知不执行。",
