...
_COMPACT_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "browser_perceive": "Browser SMC Phase 1 只读感知（opt-in loopback CDP host）：仅 snapshot/hydrate；DOM+AX→WorldSnapshot/SemanticObject，冲突/coverage/scope/grounding 如实返回；不导航、不点击、不输入、不执行脚本、不暴露 selector/坐标/CDP node id/AX index。",
