...
_COMPACT_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "smx_perceive": "smx 感知层（opt-in）：wait 单谓词离散轮询，satisfied=true/false/null，并给 sample_count/observer_error_count；snapshot 绑定 roots/depth，diff 先给 comparable/scope_relation，不可比不报变化；只感知不执行。",
