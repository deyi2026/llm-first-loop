...
_COMPACT_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "smx_perceive": "smx 感知层（opt-in）：wait 用 satisfied=true/false/null，并给 sample_count/observer_error_count；snapshot 绑定 scope；diff 先给 comparable/scope_relation，incomplete 用 field_completeness 标 unknown/lower-bound；只感知不执行。",
