...
_COMPACT_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "smx_perceive": "smx 感知层（opt-in）：wait 单谓词离散轮询，satisfied=true/false/null=满足/有效采样未满足/不可判，并给 interval/sample_count/observer_error_count；snapshot/diff/receipt 只感知不执行，执行走 execute_command。",
