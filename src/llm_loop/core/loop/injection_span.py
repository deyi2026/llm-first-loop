"""InjectionSpan 登记面（main P1 8.x；自 err1210.py 拆出，语义零改动）.

混合线裁定: ours 退役线要求 err1210 模块不再暴露注入控制面符号
（test_retired_recovery_control_plane_absent），而 main 的 build 聚合链与
fingerprint/cognitive_compiler/cr_r1 语料依赖 InjectedEntry/SlotKind/
