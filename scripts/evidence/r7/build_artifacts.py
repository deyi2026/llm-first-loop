...
FIXTURE_OUT = ROOT / "tests/fixtures/evidence_r7/fixtures_v1.json"
MATRIX_OUT = ROOT / "tests/fixtures/evidence_r7/matrix_v1.json"
SEED = 20260826

fixture_payload = {
    "schema": "evidence-r7-fixtures-v1",
...
for idx, row in enumerate(rows, 1):
    row["run_id"] = f"R7-{idx:03d}"
MATRIX_OUT.write_text(
    json.dumps(
        {"schema": "evidence-r7-matrix-v1", "random_seed": SEED, "count": len(rows), "runs": rows},
        ensure_ascii=False,
        indent=2,
    )
    + "\n",
