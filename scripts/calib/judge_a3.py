...
from scripts.calib.fixtures_a3 import INITIAL_PACKETS_A3, ORACLES_A3  # noqa: E402
...
JDIR = ROOT / "data/calib/a3_judges"
...
def case_for(o):
    ...
    return {
        "task": build_task_prompt(o["seed_id"], INITIAL_PACKETS_A3),
...
def do_judge(o, provider, case):
    ...
    j = judge_case(case, provider, f"A3-JUDGE-{provider}-{o['run_id']}")
    p.write_text(
        json.dumps(
