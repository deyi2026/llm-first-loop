#!/usr/bin/env python3
"""Serial orchestrator for semantic_execute treatment-only confirmatory qualification."""
...
def execution_manifest(plan: list[dict[str, Any]], tmp_root: Path) -> dict[str, Any]:
    ...
    if not semantic.get("perceive_fcr_visible"):
        raise RuntimeError("browser_perceive FCR contract missing")
    ...
    return {
        ...
        "surfaces": surfaces,
        "treatment": {
            "mode": "treatment_only_confirmatory",
