"""Frozen MF-5.3.1 root-direct Perceive+Operate measured Browser qualification protocol."""
...
SCHEMA = "smc.browser_cognition_preserving_actuation_mf531.v0.1"
SEED = 2026091620
IMPLEMENTATION_COMMIT = "1cb9ad2bddd8b44ca31dd38ff1b30c9dd42c01e0"
...
BROWSER_CAPABILITIES = ("browser_perceive", "browser_semantic_operation")
ROWS = (
    ("click_commit", 1),
    ("fill_submit", 1),
    ("delayed_wait", 1),
...
def build_plan(seed: int = SEED) -> list[dict[str, Any]]:
    if seed != SEED:
        raise ValueError("MF-5.3.1 plan seed is frozen")
    return [
        {
            "index": index,
            "task_id": task_id,
            "repeat": repeat,
            "arm": "root_direct_perceive_operate",
