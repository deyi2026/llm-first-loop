"""Frozen MF-5.3 Perceive+Operate measured Browser qualification protocol."""
...
SCHEMA = "smc.browser_cognition_preserving_actuation_mf53.v0.1"
SEED = 2026091619
IMPLEMENTATION_COMMIT = "b831b3992d02fec280d1098e9d71a7b26a3ed776"
...
def build_plan(seed: int = SEED) -> list[dict[str, Any]]:
    if seed != SEED:
        raise ValueError("MF-5.3 plan seed is frozen")
    return [
        {
            "index": index,
            "task_id": task_id,
            "repeat": repeat,
            "arm": "perceive_operate",
