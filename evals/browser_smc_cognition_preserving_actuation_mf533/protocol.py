"""Frozen MF-5.3.3 B1 direct-DOM-text + A-prime URL-role Perceive+Operate measured Browser qualification protocol."""
...
SCHEMA = "smc.browser_cognition_preserving_actuation_mf533.v0.1"
SEED = 2026091622
IMPLEMENTATION_COMMIT = "14dfdb407a098d4efa3c9c16476dd0a5239ceb39"
...
def build_plan(seed: int = SEED) -> list[dict[str, Any]]:
    if seed != SEED:
        raise ValueError("MF-5.3.3 plan seed is frozen")
    return [
        {
            "index": index,
            "task_id": task_id,
            "repeat": repeat,
            "arm": "b1_direct_dom_text_a_prime_url_role",
