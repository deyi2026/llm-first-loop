# MF-5.3.2 peer-capability + evidence-quality Perceive + Operate measured qualification protocol v0.1

Status: **FROZEN BEFORE ANY MF-5.3.2 MODEL REQUEST**
Date: 2026-09-16
Implementation anchor: `05d0f36c7202a8c183a517813815f6ef83f2cfe4`

## Purpose

Qualify the combined, independently deterministic-qualified MF-5.3.2A + MF-5.3.2B treatment after MF-5.3.1 exposed capability-routing and bounded-projection salience as separate residual taxes. The model keeps ordinary task reasoning and receives only two Browser concepts:

- `browser_perceive`: seven closed root-direct branches: snapshot / exact hydrate / exact diff / four flat read-only wait kinds;
- `browser_operate`: one already-decided direct mutation; internal historical receipt/storage schema identity remains unchanged.
