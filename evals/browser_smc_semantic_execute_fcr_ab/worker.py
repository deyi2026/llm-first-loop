...
def _apply_surface_treatment(engine: Any, arm: str) -> None:
    ...
    # v0.4 intentionally leaves browser_perceive on the production FCR contract in both
    # arms.  Only the full_action control mutation tool is restored to the frozen legacy
    # description; semantic_execute uses the production v0.4 contract unchanged.
    if arm == "full_action":
