"""Frozen MF-5.3.4 B1 direct-DOM-text + A-prime URL-role Perceive+Operate measured Browser qualification protocol."""
...
SCHEMA = "smc.browser_cognition_preserving_actuation_mf534.v0.1"
SEED = 2026091623
IMPLEMENTATION_COMMIT = "d644e379a250f9787f51c4d16967828972a4eecd"
...
def build_plan(seed: int = SEED) -> list[dict[str, Any]]:
    if seed != SEED:
        raise ValueError("MF-5.3.4 plan seed is frozen")
    return [
        {
            "index": index,
            "task_id": task_id,
            "repeat": repeat,
            "arm": "grounding_ref_object_wait",
