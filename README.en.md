...
> **License**: [Apache-2.0](LICENSE) ｜ **Version**: 0.6.6 ｜ **Status**: Open-source framework-ization (Track B) in progress ｜ **中文版**: [README.md](README.md)
...
- **CI + versioning** (T7/B11): GitHub Actions three-gate checks (pytest/ruff/pyright) + nightly real evaluation; semantic versioning v0.6.6; Release Drafter (PR titles auto-categorized into the changelog) + tag-triggered gate re-check + Release draft (institutionalized release cadence)
