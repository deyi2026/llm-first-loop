...
- **CI + versioning** (T7/B11): GitHub Actions three-gate checks (pytest/ruff/pyright) + nightly real evaluation; semantic versioning v0.6.13; tag-triggered gate re-check + single-writer Release draft + GitHub-generated release notes (institutionalized release cadence)
