...
> 状态：**R5 / P1-A + P1-B + P1-C 已验证完成**（修订记录见附录 A）
> 日期：2026-09-03
...
> 当前修订：**R5 Rule-first 收正**——P1-C 退役 Injection Profile / semantic Injection Budget 运行时控制；Prompt Eligibility deny-by-default 与物理 context/window/overflow/compaction 资源边界继续保留。历史 R2/R8 章节仅作演进证据。
