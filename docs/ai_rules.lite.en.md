# docs/ai_rules.lite.md — Agent/maintenance playbook (version=13; current-task authority + agency-first, owner-approved 2026-09-04)
...
## Key constraints (v13 retained set)
