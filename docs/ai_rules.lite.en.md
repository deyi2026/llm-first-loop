# docs/ai_rules.lite.md — Agent/maintenance playbook (version=16; tool-contract truth + development/repair safety + current-task authority + agency-first; 2026-09-11)
...
## Key constraints (v16 retained set)
