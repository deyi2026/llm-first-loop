...
_MIXIN_CAP = 10  # B5-W4-02a 实测 10 个（_RuntimeParamsMixin → RuntimeParamsService；累计 _Signals/_Overflow/_Err1210/_ToolExec/_ToolEligibility/_RuntimeParams）；只允许随退役单调递减
